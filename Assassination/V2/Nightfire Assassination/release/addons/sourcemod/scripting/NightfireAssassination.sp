...
/*
	Todo:
	- Code exceptions for Spies. These will include the assassinship not changing if a Spy assassin is killed with the dead ringer, the buff not being enabled if the Spy is cloaked
	and the player tint matching whatever team the Spy is disguised as.
*/
